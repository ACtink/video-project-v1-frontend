...
//           <stop offset="50%" stopColor="#8b5cf6" stopOpacity="0.17" />
//           <stop offset="100%" stopColor="#06b6d4" stopOpacity="0.11" />
//         </linearGradient>
//         <linearGradient id="dw2" x1="0" y1="0" x2="1" y2="0">
//           <stop offset="0%" stopColor="#ec4899" stopOpacity="0.09" />
//           <stop offset="50%" stopColor="#a855f7" stopOpacity="0.14" />
//           <stop offset="100%" stopColor="#6366f1" stopOpacity="0.09" />
//         </linearGradient>
//       </defs>
//       <path className="wp" fill="url(#dw0)" />
//       <path className="wp" fill="url(#dw1)" />
...
//               position: "relative",
//               boxShadow:
//                 "0 0 0 1px rgba(139,92,246,0.4), 0 0 14px rgba(139,92,246,0.35)",
//             }}
//           >
//             {a.emoji}
//           </div>
...
//               background: "#22c55e",
//               boxShadow:
//                 "0 0 0 2px rgba(34,197,94,0.3), 0 0 10px rgba(34,197,94,0.6)",
//             }}
//           />
//           <span style={{ fontSize: 11, color: "#475569" }}>
//             Meeting right now
...
//         boxShadow:
//           "0 8px 48px rgba(0,0,0,0.55), 0 0 0 1px rgba(139,92,246,0.14), 0 0 60px rgba(139,92,246,0.22), 0 0 90px rgba(236,72,153,0.12)",
//         padding: "16px 14px",
//         width: "100%",
//         maxWidth: 270,
//       }}
...
//         borderRadius: 99,
//         background:
//           "linear-gradient(135deg,rgba(99,102,241,0.14),rgba(236,72,153,0.1))",
...
//         @keyframes glowPulse{0%,100%{filter:drop-shadow(0 0 18px rgba(139,92,246,0.55)) drop-shadow(0 0 36px rgba(236,72,153,0.28))}50%{filter:drop-shadow(0 0 30px rgba(139,92,246,0.8)) drop-shadow(0 0 54px rgba(236,72,153,0.42))}}
...
//           font-size:clamp(14px,3.5vw,15px);font-weight:800;color:#fff;letter-spacing:-0.01em;
//           background:linear-gradient(90deg,#6366f1,#8b5cf6,#ec4899,#8b5cf6,#6366f1);background-size:300% auto;
//           box-shadow:0 4px 24px rgba(99,102,241,0.45),0 0 40px rgba(139,92,246,0.3),0 0 70px rgba(236,72,153,0.18);
//           transition:transform 0.18s ease,box-shadow 0.18s ease;
//           font-family:inherit;-webkit-tap-highlight-color:transparent;touch-action:manipulation;
...
//           pointer-events:none;
//         }
//         .lnd-btn-p:hover{animation:shimmerBtn 1.4s linear infinite;transform:translateY(-2px);box-shadow:0 8px 32px rgba(99,102,241,0.65),0 0 55px rgba(139,92,246,0.45),0 0 90px rgba(236,72,153,0.28)}
//         .lnd-btn-p:active{transform:scale(0.97)}

//         .lnd-btn-s{
//           display:block;width:100%;padding:15px 32px;border-radius:14px;
//           border:1px solid rgba(139,92,246,0.4);cursor:pointer;
//           font-size:clamp(14px,3.5vw,15px);font-weight:700;color:#c7d2fe;
//           background:rgba(99,102,241,0.1);transition:all 0.18s ease;
//           font-family:inherit;letter-spacing:-0.01em;
//           box-shadow:0 0 20px rgba(99,102,241,0.12);
//           -webkit-tap-highlight-color:transparent;touch-action:manipulation;
//         }
//         .lnd-btn-s:hover{background:rgba(99,102,241,0.18);border-color:rgba(139,92,246,0.7);color:#e0e7ff;box-shadow:0 0 30px rgba(99,102,241,0.25)}
//         .lnd-btn-s:active{transform:scale(0.97)}
...
//         .lnd-pills{display:flex;gap:8px;flex-wrap:wrap;justify-content:center}
//         .lnd-av{display:flex;justify-content:center}
//         .lnd-headline-accent{animation:glowPulse 4s ease-in-out infinite}
...
//           .lnd-text{align-items:flex-start;text-align:left;flex:1;max-width:520px}
//           .lnd-chat{display:block;flex-shrink:0}
//           .lnd-btns{align-self:flex-start}
//           .lnd-pills{justify-content:flex-start}
//           .lnd-av{justify-content:flex-start}
//         }
...
//             inset: 0,
//             background:
//               "radial-gradient(ellipse 70% 55% at 50% 38%,rgba(99,102,241,0.11) 0%,transparent 70%)",
//           }}
//         />
//         <div
//           style={{
...
// Random "online now" count — regenerates every time this component mounts
// (first load, full page reload, or coming back after logout).
...
function AvatarStack() {
  const [onlineCount] = useState(getRandomOnlineCount);
