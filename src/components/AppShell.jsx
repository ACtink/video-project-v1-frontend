...
function AppShell({ user, setShowHeader }) {
  // ✅ NEW: store which profile to show
  ...
  // ✅ NEW: function to open any profile
 const [profileUser, setProfileUser] = useState(null);

 const openProfile = (userObject) => {
  ...
  const renderView = () => {
    switch (activeTab) {
      ...
      default:
        // ✅ pass openProfile to HomeView
        return <HomeView openProfile={openProfile} />;
    }
  };
