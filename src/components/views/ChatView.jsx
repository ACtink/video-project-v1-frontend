  ...
  return (
    <div className="w-full h-full min-h-0 flex flex-col relative overflow-hidden text-white bg-[#020617]">
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        >
          <div className="flex-shrink-0 px-4 py-4 border-b border-white/10">
            <h2 className="text-white font-semibold text-base sm:text-[16px] tracking-tight">
              Chats
            </h2>
            <p className="text-white/40 text-sm mt-0.5">Your conversations</p>
          </div>
          ...
          >
            ...
            {!loading && chats.length === 0 && (
              <p className="p-4 text-white/40 text-sm">No chats available</p>
            )}
              ...
              chats.map((chat) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="relative flex-shrink-0">
                        <div className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-neutral-700 bg-neutral-800 flex items-center justify-center">
                          {otherUser?.profilePicture ? (
                            <img
                              src={otherUser.profilePicture}
                              alt={otherUser.username}
                        ...
                        {unread > 0 && (
                          <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 rounded-full bg-indigo-500 text-white text-[11px] font-bold flex items-center justify-center leading-none shadow-md">
                            {unread > 99 ? "99+" : unread}
                          </span>
                        )}
                      </div>
                      ...
                      {isMenuOpen && (
                        <div className="absolute right-0 top-8 z-[999] w-44 rounded-xl bg-neutral-900 border border-white/10 shadow-2xl overflow-hidden">
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-red-400 hover:text-red-300 hover:bg-white/5 transition-colors duration-150 text-left"
                          >
                            <Trash2 size={14} />
                            Delete chat
                          </button>
